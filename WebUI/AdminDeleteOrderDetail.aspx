<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminDeleteOrderDetail.aspx.cs" Inherits="AdminDeleteOrderDetail" %>
      ...
      <asp:GridView ID="GridView1" runat="server"    DataKeyNames="oid" style=" margin:0 auto;margin-top:15px;" Width="95%"   AutoGenerateColumns="False"  onrowcommand="GridView1_RowCommand" >
                               <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="订单管理">
                                    <ItemTemplate>
                                        <asp:Button ID="Button2" runat="server" CommandArgument='<%# Eval("oid") %>' CssClass="Button2" Width="70" CommandName="移除" Text="移除" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
